...
class GetValue extends BaseElementCommand {
  ...
  protocolAction() {
    if (this.api.capabilities) {
      // FIXME: temporary fix to get safari working by Topperfalkon in https://github.com/nightwatchjs/nightwatch/pull/2425/files
      ...
      if (browserName.toLowerCase() === BrowserName.SAFARI && (browserVersion >= 2) &&
      this.settings.webdriver.start_process === true) {
